#! /usr/bin/env python
#
# A simple program to play with IRC. Based on the
# Example program using ircbot.py.
# Joel Rosdahl <joel@rosdahl.net>

# I modified it to monitor some wepages and to tell us whether
# galactus Rocks or not.
    ...
    def do_command(self, e, cmd):
        ...
        if cmd == "disconnect":
            ...
            self.die()
                ...
                if random.random() > 0.5: g = 'sucks'
                else: g= 'rules'
                c.notice(nick, "Galactus " + g)
        elif cmd == "stats":
            ...
            c.notice(nick, "Not understood (Ask for 'help'): " + cmd)
