...
#line 99 "tam_input.tab.c" /* yacc.c:339  */
...
#line 153 "tam_input.tab.c" /* yacc.c:358  */
...
{
       0,    39,    39,    40,    42,    43,    49,    52,    53,    54,
      55,    56,    57,    60,    63,    66,    69,    70
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "STRING", "SYMBOL", "'\\n'",
  "'\\''", "'('", "')'", "$accept", "input", "line", "exp", "quote",
  "open", "close", "exps", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,    10,    39,    40,    41
};
# endif
...
{
       2,     0,     1,     6,     7,     8,     9,     4,    13,    14,
       3,     5,     0,     0,    11,    15,    16,    12,    16,     0,
      17,    10
};
...
{
     -10,   -10,   -10,    -1,   -10,   -10,    -9,    -2
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,    10,    18,    12,    13,    17,    19
};
...
{
      11,     2,     3,    15,     4,     5,     6,     7,     8,     9,
      21,    14,    16,     4,     5,     6,    20,     8,     9,    15,
       4,     5,     6,     0,     8,     9
};
...
{
       0,    11,     0,     1,     3,     4,     5,     6,     7,     8,
      12,    13,    14,    15,    13,     9,    13,    16,    13,    17,
      17,    16
};
...
#line 73 "tam_input.y" /* yacc.c:1906  */
