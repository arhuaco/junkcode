...
void
TMoveGenerator::MakeMoveListAux( int Square, int Depth){
...
void
TMoveGenerator::MakeMoveList( int *Board, TPlayer Player, TMoveList *MoveList){
...
void
TMoveGenerator::InitBoard(int *Board){
...
void
TMoveGenerator::MakeMove(int Move[],int *Board){
...
bool
TMoveGenerator::NoMovesLeft( int *Board, TPlayer Player){
